  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
            <h1 class="m-0">Ingresar Nueva Compra</h1>
      </div>
    </div>
    <!--contenido-->
    <div class="content">
        <div class="container-fluid">
         <div class="row">
                          ...
                          <div class="row">                            
                             ...
                             <div class="col-md-4">
                                   <div class="form-group">
                                      ...
                                      <input type="number" id="telefono_empresa" class="form-control" disabled>
                                  </div>
                              </div>
                         </div>
                         <div class="row">
            ...
            <div class="col-md-3">
              <div class="card" style="border-top: 4px solid #038510;">
                 ...
                 <div class="row">
                      ...
                      <div class="col-md-12">
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="precio_compra_total">
                          </div>
                      </div>
                      <div class="col-md-6">
                          <div class="form-group">
                      ...
                      <div class="col-md-12">
                          <div class="form-group">
                              ...
                              <input type="number" id="cantidad_de_la_compra" class="form-control">
                              <script>
                  ...
                  <div class="col-md-12">
                        <div class="form-group">
                            <button class="btn btn-block" style="background: #038510; color: white" id="btn_guardar_compra">Guardar Compra</button>
                        </div>
                 </div>
                 <script>
                    $('#btn_guardar_compra').click(function(){
                        ...
                        if(id_producto == ""){
                           ...
                           alert("Todos los campos son requeridos");
                            ...
                            var url = "../app/controllers/compras/crear_compra.php";
                             $.get(url, {id_producto: id_producto, numero_compra: numero_compra, fecha_compra: fecha_compra, comprobante: comprobante, id_proveedor: id_proveedor, id_usuario: id_usuario, precio_compra_total: precio_compra_total, cantidad_de_la_compra: cantidad_de_la_compra, stock_total: stock_total}, function(datos){
                             $('#respuesta_crear').html(datos);
                            });
                        }
             ...
             <div class="" id="respuesta_crear"> </div> 
